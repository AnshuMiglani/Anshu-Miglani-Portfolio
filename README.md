...
- **LinkedIn**: [linkedin.com/in/anshu-miglani-a00755257](https://www.linkedin.com/in/anshu-miglani-a00755257/)
- **GitHub**: [github.com/AnshuMiglani](https://github.com/AnshuMiglani)
- **LeetCode**: [leetcode.com/u/Anshu_Miglani](https://leetcode.com/u/Anshu_Miglani/) (400+ Solved, 5★ HackerRank C++)
- **Email**: [anshumiglani0808@gmail.com](mailto:anshumiglani0808@gmail.com)
- **Phone**: +91 9350871220
...
- **SDE Intern** at **Transpacks Technologies Pvt. Ltd.** (Oct 2025 – Aug 2026)
  - Developed logistics and supply-chain features using **Next.js, FastAPI, and Strapi**, supporting 100+ concurrent users.
  - Built real-time dashboards & REST APIs, reducing data lookup time by **30%**.
  - Containerized services with **Docker** and deployed on **AWS**.
  - Reduced deployment issues by **20%** via code reviews and CI/CD.
...
5. **Aesthetics & Performance**: Custom cursor glow, 3D tilt effects, parallax orbital hero, and zero external JS framework overhead.

---

## 🌐 Deploy on GitHub Pages

1. Push files to your repository `Anshu-Miglani-Portfolio`.
2. In GitHub: **Settings → Pages → Deploy from branch → `main` / root**.
3. Your portfolio will be live at `https://anshumiglani.github.io/Anshu-Miglani-Portfolio/`.
